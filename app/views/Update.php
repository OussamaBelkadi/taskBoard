...
<div class="container">  
    <div class="card">
        <div class="card-body">
          <form action="<?php echo'/task/insertupdate/'.$element['id']?>" method="POST" id="connect">
              ...
              <a href="<?php echo BURL.'task/returnl'?>"><button type="button" class="btn btn-secondary w-25" data-bs-dismiss="modal">Close</button></a>          </form>
        </div>
        </div>
      </div>
    </div>
